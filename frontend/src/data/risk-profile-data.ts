...
export const RISK_PROFILE_DATA: Record<string, RiskProfileData> = {
  ...
  "Contoso Energy Phase 2": {
    ...
    executiveBrief: {
      riskTier: "Low Risk",
      headlineRisk: "Low-complexity engagement. Primary risk areas align to low delivery profile patterns.",
      precedentSignal: "8 comparable engagements with 94% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment tempered by 1 regulatory dimension(s).",
      marketContext: "Standard low-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Low Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Low solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "8 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["36% margin — strong buffer for low-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: NERC CIP", "Standard governance burden — proven Lamna Healthcare/Proseware/Northwind Pharma patterns available"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "8 comparable engagements with 94% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 9.0,     strength: "Low complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 9.2, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.7, strength: "36% margin — strong.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 9.0, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 7.5, strength: "1 regulatory dimension(s)", gaps: [], recommendation: "Apply Regulatory Volatility standing risk from QA Network." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    referenceProjects: [
      { name: "See Delivery Success Intelligence popup for comparable engagements", industry: "Multiple", year: 2026, outcome: "success", relevance: "High", lesson: "Refer to Delivery Success Intelligence for full precedent analysis with comparable outcomes, knowledge network lessons, and recommended team." },
    ],
    agentMatches: [
      { name: "See Delivery Success Intelligence", role: "Delivery Agent Recommendation", credits: [], industries: ["Multiple"], availability: "See Delivery Success popup", regions: ["Americas"] },
    ],
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 36% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "The Volcano Coffee Company Phase 2": {
    ...
    executiveBrief: {
      riskTier: "Low Risk",
      headlineRisk: "Low-complexity engagement. Primary risk areas align to low delivery profile patterns.",
      precedentSignal: "4 comparable engagements with 92% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard low-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Low Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Low solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "4 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["38% margin — strong buffer for low-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "4 comparable engagements with 92% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 9.5,     strength: "Low complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 9.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 9.1, strength: "38% margin — strong.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 9.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    referenceProjects: [
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 38% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Wide World Importers Power BI": {
    ...
    executiveBrief: {
      riskTier: "Low Risk",
      headlineRisk: "Low-complexity engagement. Primary risk areas align to low delivery profile patterns.",
      precedentSignal: "6 comparable engagements with 95% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard low-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Low Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Low solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "6 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["40% margin — strong buffer for low-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "6 comparable engagements with 95% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 9.5,     strength: "Low complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 9.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 9.5, strength: "40% margin — strong.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 9.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 40% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Tailspin Toys D365": {
    ...
    executiveBrief: {
      riskTier: "Low Risk",
      headlineRisk: "Low-complexity engagement. Primary risk areas align to low delivery profile patterns.",
      precedentSignal: "5 comparable engagements with 91% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard low-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Low Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Low solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "5 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["34% margin — adequate buffer for low-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "5 comparable engagements with 91% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 9.0,     strength: "Low complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 9.2, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.3, strength: "34% margin — adequate.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 9.0, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 34% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Liberty's Bakery Phase 2": {
    ...
    executiveBrief: {
      riskTier: "Low Risk",
      headlineRisk: "Low-complexity engagement. Primary risk areas align to low delivery profile patterns.",
      precedentSignal: "6 comparable engagements with 89% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard low-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      ...
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Low solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "6 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["35% margin — strong buffer for low-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "6 comparable engagements with 89% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 9.0,     strength: "Low complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 9.2, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.5, strength: "35% margin — strong.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 9.0, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 35% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "School of Fine Art Expansion": {
    ...
    executiveBrief: {
      riskTier: "Low Risk",
      headlineRisk: "Low-complexity engagement. Primary risk areas align to low delivery profile patterns.",
      precedentSignal: "3 comparable engagements with 90% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard low-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Low Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Low solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "3 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["33% margin — adequate buffer for low-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "3 comparable engagements with 90% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 8.5,     strength: "Low complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 8.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.1, strength: "33% margin — adequate.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 8.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 33% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Margie's Travel Phase 2": {
    ...
    executiveBrief: {
      riskTier: "Managed Risk",
      headlineRisk: "Medium-complexity engagement. Primary risk areas align to medium delivery profile patterns.",
      precedentSignal: "5 comparable engagements with 89% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard medium-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Managed Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Medium solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "5 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["34% margin — adequate buffer for medium-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "5 comparable engagements with 89% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 8.0,     strength: "Medium complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 8.2, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.3, strength: "34% margin — adequate.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 8.0, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
  ...
  "VanArsdel Manufacturing Wave 2": {
    ...
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Low Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Medium solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "4 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["36% margin — strong buffer for medium-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
    ...
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 8.5,     strength: "Medium complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 8.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.7, strength: "36% margin — strong.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 8.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
  ...
  "Trey Research Pharma Expansion": {
    ...
    executiveBrief: {
      riskTier: "Managed Risk",
      headlineRisk: "Medium-complexity engagement. Primary risk areas align to medium delivery profile patterns.",
      precedentSignal: "3 comparable engagements with 88% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment tempered by 2 regulatory dimension(s).",
      marketContext: "Standard medium-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Managed Risk. Strong delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Medium solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "3 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["33% margin — adequate buffer for medium-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: 21 CFR Part 11, GDPR", "Standard governance burden — proven Lamna Healthcare/Proseware/Northwind Pharma patterns available"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "3 comparable engagements with 88% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 7.5,     strength: "Medium complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 7.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 8.1, strength: "33% margin — adequate.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 7.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 6.0, strength: "2 regulatory dimension(s)", gaps: [], recommendation: "Apply Regulatory Volatility standing risk from QA Network." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    referenceProjects: [
  ...
  "Lucerne Publishing AI": {
    ...
    executiveBrief: {
      riskTier: "Managed Risk",
      headlineRisk: "Medium-complexity engagement. Primary risk areas align to medium delivery profile patterns.",
      precedentSignal: "3 comparable engagements with 87% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment.",
      marketContext: "Standard medium-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      ...
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Medium solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "3 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["31% margin — adequate buffer for medium-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "3 comparable engagements with 87% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 7.0,     strength: "Medium complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 7.2, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 7.7, strength: "31% margin — adequate.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 7.0, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 31% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "The Phone Company Contact Center AI": {
    ...
    executiveBrief: {
      riskTier: "Managed Risk",
      headlineRisk: "Medium-complexity engagement. Primary risk areas align to medium delivery profile patterns.",
      precedentSignal: "3 comparable engagements with 85% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "High confidence. Strong playbook alignment tempered by 1 regulatory dimension(s).",
      marketContext: "Standard medium-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve. Standard governance applies.",
    },
    sections: [
      ...
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Medium solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "3 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["30% margin — adequate buffer for medium-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: GDPR", "Standard governance burden — proven Lamna Healthcare/Proseware/Northwind Pharma patterns available"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "3 comparable engagements with 85% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 7.5,     strength: "Medium complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 7.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 7.5, strength: "30% margin — adequate.", gaps: [], recommendation: "Standard commercial terms." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 7.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 7.5, strength: "1 regulatory dimension(s)", gaps: [], recommendation: "Apply Regulatory Volatility standing risk from QA Network." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "ok", detail: "Margin at 30% provides adequate buffer." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Litware Manufacturing SCM": {
    ...
    executiveBrief: {
      riskTier: "Elevated Risk",
      headlineRisk: "Medium-complexity engagement. Primary risk areas align to medium delivery profile patterns.",
      precedentSignal: "3 comparable engagements with 82% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "Moderate confidence. Strong playbook alignment.",
      marketContext: "Standard medium-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve with conditions per AI recommendation. Apply preventive lessons from QA Knowledge Network.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Elevated Risk. Moderate delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["Medium solution complexity", "Direct Microsoft PS delivery — no vendor coordination", "3 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["28% margin — adequate buffer for medium-complexity work", "Full margin retention — no vendor dilution"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: None significant", "No special regulatory overlay"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["No partner dependency — clean delivery model"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "3 comparable engagements with 82% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 6.5,     strength: "Medium complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 6.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 7.1, strength: "28% margin — adequate.", gaps: ["Tight margin"], recommendation: "Margin floor review." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 6.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 9.5, strength: "No special regulatory requirements", gaps: [], recommendation: "Standard governance." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 9.0, strength: "No vendor dependency — clean model", gaps: [], recommendation: "No action." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "warning", detail: "Margin at 28% — review with Finance." },
      { label: "Vendor → Delivery Control",   status: "ok",       detail: "Direct delivery or low vendor dependency." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Tailwind Traders D365": {
    ...
    executiveBrief: {
      riskTier: "High Risk",
      headlineRisk: "High-complexity engagement with Regional SI Partner (25% vendor participation). Primary risk areas align to high delivery profile patterns.",
      precedentSignal: "2 comparable engagements with 75% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "Cautious confidence. Strong playbook alignment tempered by 2 regulatory dimension(s).",
      marketContext: "Standard high-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve only with formal Risk Mitigation Plan and Architecture Review Board assessment.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "High Risk. Constrained delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["High solution complexity", "Regional SI Partner subcontracts 25% — coordination adds load", "2 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["24% margin — tight buffer for high-complexity work", "Vendor participation at 25% reduces retained margin"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: GDPR, Local Payroll (8 jurisdictions)", "Standard governance burden — proven Lamna Healthcare/Proseware/Northwind Pharma patterns available"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["Regional SI Partner subcontract (25%) requires SLA and quality oversight"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "2 comparable engagements with 75% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 4.5,     strength: "High complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 4.7, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 6.3, strength: "24% margin — tight.", gaps: ["Tight margin"], recommendation: "Margin floor review." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 4.5, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 6.0, strength: "2 regulatory dimension(s)", gaps: [], recommendation: "Apply Regulatory Volatility standing risk from QA Network." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 5, strength: "Regional SI Partner partnership documented", gaps: [], recommendation: "Vendor SOW with explicit quality terms." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    referenceProjects: [
      { name: "See Delivery Success Intelligence popup for comparable engagements", industry: "Multiple", year: 2026, outcome: "success", relevance: "High", lesson: "Refer to Delivery Success Intelligence for full precedent analysis with comparable outcomes, knowledge network lessons, and recommended team." },
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "warning", detail: "Margin at 24% — review with Finance." },
      { label: "Vendor → Delivery Control",   status: "warning",       detail: "25% vendor share requires explicit SLA terms." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
  "Coho Vineyard ERP": {
    ...
    executiveBrief: {
      ...
      headlineRisk: "High-complexity engagement with Avanade (30% vendor participation). Primary risk areas align to high delivery profile patterns.",
      precedentSignal: "2 comparable engagements with 65% delivery success rate. Reference patterns directly applicable.",
      deliveryConfidence: "Cautious confidence. Strong playbook alignment tempered by 1 regulatory dimension(s).",
      marketContext: "Standard high-complexity engagement profile. No unusual market signals.",
      decisionGuidance: "Approve only with formal Risk Mitigation Plan and Architecture Review Board assessment.",
    },
    sections: [
      { id: "executive-brief",        number: "1.", title: "Executive Risk Brief",   sectionType: "brief",    content: [{ t: "p", text: "Critical Risk. Constrained delivery profile with proven playbook coverage. Apply Knowledge Network lessons as standing risks." }] },
      { id: "delivery-complexity",    number: "2.", title: "Delivery Complexity",     sectionType: "standard", dimensionKey: "delivery_complexity",   content: [{ t: "bullets", items: ["High solution complexity", "Avanade subcontracts 30% — coordination adds load", "2 comparable engagements provide pattern coverage"] }] },
      { id: "client-readiness",       number: "3.", title: "Client Readiness",        sectionType: "standard", dimensionKey: "client_readiness",      content: [{ t: "bullets", items: ["Client sponsorship aligned with deal scope", "Steering cadence to be confirmed at kickoff", "Knowledge Network seed pattern applies"] }] },
      { id: "commercial-structure",   number: "4.", title: "Commercial Structure",     sectionType: "standard", dimensionKey: "commercial_structure",  content: [{ t: "bullets", items: ["21% margin — tight buffer for high-complexity work", "Vendor participation at 30% reduces retained margin"] }] },
      { id: "execution-resourcing",   number: "5.", title: "Execution & Resourcing",   sectionType: "standard", dimensionKey: "execution_resourcing",  content: [{ t: "bullets", items: ["Practice capacity adequate", "Recommended PMs identified via Delivery Agent", "Apply Bi-weekly RAID cadence from QA Knowledge Network"] }] },
      { id: "regulatory-compliance",  number: "6.", title: "Regulatory & Compliance",  sectionType: "standard", dimensionKey: "regulatory_compliance", content: [{ t: "bullets", items: ["Regulatory dimensions: GDPR", "Standard governance burden — proven Lamna Healthcare/Proseware/Northwind Pharma patterns available"] }] },
      { id: "partner-ecosystem",      number: "7.", title: "Partner & Ecosystem",      sectionType: "standard", dimensionKey: "partner_ecosystem",     content: [{ t: "bullets", items: ["Avanade subcontract (30%) requires SLA and quality oversight"] }] },
      { id: "technology-maturity",    number: "8.", title: "Technology Maturity",      sectionType: "standard", dimensionKey: "technology_maturity",   content: [{ t: "bullets", items: ["Microsoft platform mature for this service line", "Reference architecture available from prior engagements"] }] },
      { id: "precedent-intelligence", number: "9.", title: "Precedent Intelligence",   sectionType: "precedent", content: [{ t: "p", text: "2 comparable engagements with 65% delivery success rate. See Delivery Success Intelligence popup for full precedent analysis." }] },
      { id: "delivery-agent-intelligence", number: "10.", title: "Delivery Agent Intelligence", sectionType: "agents", content: [{ t: "p", text: "Recommended team identified via Delivery Agent. See Delivery Success Intelligence popup for capacity analysis." }] },
      { id: "market-signals",         number: "11.", title: "Market Signal Alerts",    sectionType: "signals",   content: [{ t: "p", text: "No active market signals. Standard monitoring applies." }] },
    ],
    dimensions: [
      { key: "delivery_complexity",  label: "Delivery Complexity",  weight: "20%", score: 3.0,     strength: "High complexity with proven playbook coverage.", gaps: [], recommendation: "Apply standard delivery pattern." },
      { key: "client_readiness",     label: "Client Readiness",     weight: "18%", score: 3.2, strength: "Client sponsorship documented.", gaps: [], recommendation: "Confirm steering at kickoff." },
      { key: "commercial_structure", label: "Commercial Structure", weight: "15%", score: 5.7, strength: "21% margin — tight.", gaps: ["Tight margin"], recommendation: "Margin floor review." },
      { key: "execution_resourcing", label: "Execution & Resourcing", weight: "17%", score: 3.0, strength: "Practice capacity available.", gaps: [], recommendation: "See Delivery Success popup for team match." },
      { key: "regulatory_compliance", label: "Regulatory Compliance", weight: "10%", score: 7.5, strength: "1 regulatory dimension(s)", gaps: [], recommendation: "Apply Regulatory Volatility standing risk from QA Network." },
      { key: "partner_ecosystem",    label: "Partner & Ecosystem",  weight: "10%", score: 5, strength: "Avanade partnership documented", gaps: [], recommendation: "Vendor SOW with explicit quality terms." },
      { key: "technology_maturity",  label: "Technology Maturity",  weight: "10%", score: 8.5, strength: "Microsoft platforms mature for this service line.", gaps: [], recommendation: "Standard architecture pattern applies." },
    ],
    referenceProjects: [
      { name: "See Delivery Success Intelligence popup for comparable engagements", industry: "Multiple", year: 2026, outcome: "success", relevance: "High", lesson: "Refer to Delivery Success Intelligence for full precedent analysis with comparable outcomes, knowledge network lessons, and recommended team." },
    ...
    marketSignals: [],
    alignmentFlags: [
      { label: "Margin → Commercial Health",  status: "warning", detail: "Margin at 21% — review with Finance." },
      { label: "Vendor → Delivery Control",   status: "warning",       detail: "30% vendor share requires explicit SLA terms." },
      { label: "QA Network → Risk Register",  status: "ok",                     detail: "Knowledge Network lessons applied as standing risks." },
    ],
  },
