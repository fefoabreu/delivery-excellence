...
# ── Persona shorthands ──────────────────────────────────────────────────────
E = "Elena Fontaine"   # VP Professional Services
K = "Katrina Rhodes"   # Americas Leader
M = "Marc van Vliet"   # VP Delivery Excellence
        ...
        "features": [
            {
                ...
                "stories": [
                    (E, "critical", 5, "Sprint 1", ["governance","executive"],
                     "As Elena Fontaine, I want a Delivery Council charter with defined quorum, decision rights, and escalation authority so that governance authority is formalized and respected.",
                    ...
                    (M, "high", 3, "Sprint 1", ["governance","process"],
                     "As Marc van Vliet, I want a standardized weekly delivery review template that all PMs complete by end-of-Friday so health status is consistent and the Monday review is data-driven.",
                    ...
                    (K, "high", 3, "Sprint 2", ["governance","americas"],
                     "As Katrina Rhodes, I want a bi-weekly Americas Regional Delivery Review that surfaces portfolio issues before they reach VP-level escalation so I stay ahead of client risk.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "high", 5, "Sprint 2", ["governance","documentation"],
                     "As Marc van Vliet, I want a documented Operating Rhythm Playbook (cadences, owners, inputs/outputs, escalation triggers) so the team runs consistent governance even as personnel changes.",
                    ...
                    (E, "medium", 3, "Sprint 3", ["governance","executive"],
                     "As Elena Fontaine, I want a Quarterly Business Review (QBR) template and facilitation guide so that QBRs are consistently run across all regions and feed into board-level reporting.",
            ...
            },
            {
                ...
                "stories": [
                    (E, "high", 5, "Sprint 3", ["governance","metrics"],
                     "As Elena Fontaine, I want a governance KPI dashboard (status update completion rate, RAID health, milestone on-time rate) so I can hold delivery leaders accountable with data.",
                    ...
                    (M, "medium", 3, "Sprint 4", ["governance","automation"],
                     "As Marc van Vliet, I want automated reminders sent to PMs when status updates are overdue (>48 hours past due) so I eliminate manual chasing.",
                    ...
                    (K, "medium", 2, "Sprint 4", ["governance","americas"],
                     "As Katrina Rhodes, I want a monthly Americas governance scorecard (showing each PM's compliance with standards) so I have a data-driven basis for coaching conversations.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (M, "critical", 8, "Sprint 1", ["standards","framework"],
                     "As Marc van Vliet, I want a Delivery Quality Framework document that defines what 'good' looks like at each project phase (Initiate, Plan, Execute, Monitor, Close) so PMs have a clear quality bar to work toward.",
                     ["DQF covers all 5 phases with specific quality criteria", "Reviewed and approved by Elena Fontaine", "Published as the foundational standards document"]),
                    (E, "high", 5, "Sprint 2", ["standards","governance"],
                     "As Elena Fontaine, I want mandatory quality gate reviews at project kickoff, 30% completion, and 85% completion so delivery quality issues are caught and remediated before they reach the client.",
                    ...
                    (K, "high", 3, "Sprint 3", ["standards","americas"],
                     "As Katrina Rhodes, I want the DQF adapted with Americas-specific client expectations and regulatory nuances (SOX, HIPAA, FINRA) so our standards reflect the environments our clients operate in.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "critical", 5, "Sprint 1", ["standards","presales"],
                     "As Marc van Vliet, I want a SOW quality checklist (scope completeness, assumptions, exclusions, RAID pre-check, pricing validation) that pre-sales must complete before submitting for approval so scope gaps are caught before contract signature.",
                    ...
                    (E, "high", 3, "Sprint 2", ["standards","executive"],
                     "As Elena Fontaine, I want all SOWs above $500K to require a delivery leader review and sign-off before client presentation so commercial risk is assessed by delivery before commitment.",
                    ...
                    (K, "high", 3, "Sprint 3", ["standards","americas"],
                     "As Katrina Rhodes, I want a SOW health score visible in the contracting tool (based on checklist results) so approvers can make risk-informed approval decisions at a glance.",
                     ["Health score algorithm covers scope completeness, financial risk, delivery risk", "Score displayed prominently on contract approval page", "Trend of SOW quality by pre-sales team available to Katrina Rhodes monthly"]),
                ]
            },
            {
                ...
                "stories": [
                    (M, "high", 5, "Sprint 2", ["standards","process"],
                     "As Marc van Vliet, I want a mandatory Project Initiation Checklist (PIC) that every PM completes in Week 1 so projects are set up for success from day one with the right structure, stakeholder alignment, and risk identification.",
                    ...
                    (E, "medium", 5, "Sprint 4", ["standards","talent"],
                     "As Elena Fontaine, I want a PM Standards Certification program (Bronze/Silver/Gold levels) tied to delivery quality scores so we recognize high performers and create a meaningful professional development path.",
                    ...
                    (K, "medium", 3, "Sprint 4", ["standards","americas"],
                     "As Katrina Rhodes, I want a quarterly delivery standards compliance review for Americas PMs (with coaching recommendations) so I identify who needs support before it becomes a delivery problem.",
                     ["Review covers adherence to DQF, PIC, status reporting, RAID hygiene", "Coaching plan template provided for PMs below threshold", "Results shared with Elena Fontaine in monthly governance pack"]),
                ]
            },
        ]
    },
        ...
        "features": [
            {
                ...
                "stories": [
                    (E, "critical", 8, "Sprint 1", ["insights","dashboard"],
                     "As Elena Fontaine, I want a real-time executive portfolio health dashboard with all active projects RAG status, key financials, and pipeline funnel so I can brief the board without manual preparation.",
                    ...
                    (K, "high", 5, "Sprint 2", ["insights","americas"],
                     "As Katrina Rhodes, I want a regional Americas filter on the portfolio dashboard showing pipeline value, delivery health heatmap, and margin performance so I manage my region without being distracted by other geos.",
                    ...
                    (M, "high", 5, "Sprint 3", ["insights","delivery"],
                     "As Marc van Vliet, I want a project health trend view (rolling 12-week RAG history per project) so I can distinguish one-time blips from structural delivery problems.",
            ...
            },
            {
                ...
                "stories": [
                    (E, "critical", 13, "Sprint 3", ["insights","predictive","ai"],
                     "As Elena Fontaine, I want a predictive model that flags projects likely to turn red 4–6 weeks before they do (based on RAID velocity, budget burn curve, milestone slip rate) so we can intervene while recovery is still inexpensive.",
                    ...
                    (M, "high", 8, "Sprint 4", ["insights","analytics"],
                     "As Marc van Vliet, I want trend analysis on delivery health dimensions (schedule, budget, risk, scope, satisfaction) across the portfolio over time so I can identify systemic issues rather than one-off project problems.",
                    ...
                    (K, "high", 5, "Sprint 4", ["insights","americas"],
                     "As Katrina Rhodes, I want a 'portfolio heat map by account' for Americas showing all active engagements per client and their delivery trajectory so I know which accounts need my executive attention.",
            ...
            },
            {
                ...
                "stories": [
                    (E, "high", 8, "Sprint 4", ["insights","executive","analytics"],
                     "As Elena Fontaine, I want correlation analysis between pre-sales quality indicators (SOW quality score, handoff completeness, time-in-negotiate) and delivery outcomes (margin, CSAT, RAG status) so we improve how we sell and what we commit to.",
                    ...
                    (E, "high", 5, "Sprint 5", ["insights","executive","automation"],
                     "As Elena Fontaine, I want an automated monthly executive report (generated from live data) covering pipeline health, delivery performance, margin trends, and CSAT so that report preparation takes 10 minutes not 3 days.",
                     ["Report auto-generates on 1st of each month", "Distributed via email to Elena Fontaine, Katrina Rhodes, Marc van Vliet by 7am on the 2nd", "Format matches board presentation template"]),
                    (M, "medium", 5, "Sprint 5", ["insights","reporting"],
                     "As Marc van Vliet, I want a post-project analysis report (auto-generated 60 days after project closure) covering financial performance vs. plan, CSAT score, and top lessons learned so insights are systematically captured without PM effort.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (M, "critical", 5, "Sprint 1", ["risk","process"],
                     "As Marc van Vliet, I want a standardized RAID taxonomy and scoring model (impact × probability matrix for risks, severity for issues) so all PMs classify items consistently and portfolio RAID can be aggregated meaningfully.",
                    ...
                    (K, "high", 3, "Sprint 2", ["risk","escalation"],
                     "As Katrina Rhodes, I want escalation triggers defined (e.g., HIGH-impact risk open > 14 days without mitigation) so I am automatically notified when unresolved risks cross a threshold in Americas projects.",
                    ...
                    (E, "high", 3, "Sprint 2", ["risk","executive"],
                     "As Elena Fontaine, I want a portfolio RAID heat map (top 10 open risks across all active projects, by impact) refreshed weekly so I see what could derail delivery before it does.",
            ...
            },
            {
                ...
                "stories": [
                    (E, "critical", 8, "Sprint 3", ["risk","automation","ai"],
                     "As Elena Fontaine, I want an automated alert (Teams + email) triggered whenever any project health dimension drops from green to amber so delivery leaders can engage before a project reaches red.",
                    ...
                    (M, "high", 8, "Sprint 3", ["risk","analytics"],
                     "As Marc van Vliet, I want a composite 'Project Early Warning Score' (combining schedule slip %, budget burn curve, open RAID count, and milestone overdue rate) updated weekly so I have a single quantitative signal for project health trajectory.",
                    ...
                    (K, "high", 5, "Sprint 4", ["risk","americas","ai"],
                     "As Katrina Rhodes, I want weekly AI-generated insights on Americas projects trending toward red — with specific contributing factors — so my Monday review focuses on what matters most.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "critical", 5, "Sprint 2", ["risk","change_management"],
                     "As Marc van Vliet, I want a formal Change Request (CR) process with PM-initiated, delivery-leader-approved, and client-signed-off stages so that out-of-scope work is never absorbed silently and commercial protection is consistent.",
                    ...
                    (E, "high", 5, "Sprint 3", ["risk","executive"],
                     "As Elena Fontaine, I want a Red Project Recovery Playbook (triggered automatically when a project is marked RED) that defines intervention steps, escalation owners, and recovery timelines so that our response to red projects is immediate and structured.",
                    ...
                    (K, "high", 3, "Sprint 4", ["risk","americas"],
                     "As Katrina Rhodes, I want a dedicated 'project rescue' resource pool (2 senior PMs and 2 senior architects on standby in Americas) deployable to red projects within 10 business days so recovery starts before the client escalates.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (E, "critical", 8, "Sprint 2", ["financial","margin"],
                     "As Elena Fontaine, I want a margin improvement program targeting +2 percentage points per project on average (through delivery efficiency, reuse of assets, and right-sizing teams) so our practice profitability improves without reducing client value.",
                    ...
                    (M, "high", 5, "Sprint 3", ["financial","analytics"],
                     "As Marc van Vliet, I want monthly margin analysis by project with actuals vs. plan and variance commentary so margin leakage is identified and addressed in real time — not discovered at project close.",
                    ...
                    (K, "high", 3, "Sprint 3", ["financial","americas"],
                     "As Katrina Rhodes, I want a 'Top 5 Margin at Risk' Americas report (projects with highest negative margin variance) so I can personally engage with those PMs on recovery actions.",
                     ["Report generated weekly and sent to Katrina Rhodes every Monday", "Each entry includes root cause, PM owner, and proposed action", "Actions tracked to closure"]),
                ]
            },
            {
                ...
                "stories": [
                    (M, "critical", 5, "Sprint 2", ["financial","automation"],
                     "As Marc van Vliet, I want automated budget burn alerts at 70%, 85%, and 100% of budget consumed — sent to PM, delivery leader, and VP — so overruns are flagged with enough lead time to intervene.",
                    ...
                    (E, "high", 5, "Sprint 3", ["financial","governance"],
                     "As Elena Fontaine, I want all projects at 85%+ budget burn with <80% delivery completion to require a financial recovery plan submitted to the VP within 5 business days so overruns are never a surprise.",
                    ...
                    (K, "high", 3, "Sprint 4", ["financial","americas"],
                     "As Katrina Rhodes, I want root cause analysis completed for every Americas project that exceeds budget by >10% so we identify systemic causes and implement preventive changes for future engagements.",
            ...
            },
            {
                ...
                "stories": [
                    (E, "high", 8, "Sprint 4", ["financial","resources"],
                     "As Elena Fontaine, I want a utilization dashboard showing billable vs. non-billable time by practice and individual so I can manage bench cost proactively and make data-driven staffing decisions.",
                    ...
                    (K, "high", 5, "Sprint 5", ["financial","americas"],
                     "As Katrina Rhodes, I want a 90-day forward resource demand forecast for Americas based on active projects, pipeline probability, and known departures so I can make hiring and contractor decisions with 3 months of lead time.",
                    ...
                    (M, "high", 5, "Sprint 5", ["financial","billing"],
                     "As Marc van Vliet, I want a billing accuracy dashboard showing unbilled work, delayed invoicing, and milestone billing status per project so we eliminate revenue leakage from billing process failures.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (E, "high", 8, "Sprint 2", ["readiness","talent"],
                     "As Elena Fontaine, I want a PM Competency Framework defining skills, behaviors, and knowledge required at each PM level (Associate, PM, Senior PM, Principal) so we have a clear development path and hiring bar.",
                     ["Framework covers 6 competency domains", "Approved by Elena Fontaine and HR", "Used in all PM performance reviews from Q3 2026"]),
                    (M, "high", 5, "Sprint 3", ["readiness","onboarding"],
                     "As Marc van Vliet, I want a structured 4-week PM onboarding program covering delivery standards, tooling, methodology, and shadow PM experience so all new PMs start with consistent knowledge of how we operate.",
                    ...
                    (K, "medium", 3, "Sprint 4", ["readiness","americas"],
                     "As Katrina Rhodes, I want monthly Americas PM Coaching Sessions focused on the top 2–3 recurring execution challenges in the region so we build skills on the issues that matter most right now.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "critical", 8, "Sprint 2", ["readiness","presales"],
                     "As Marc van Vliet, I want a Delivery Readiness Assessment (DRA) tool that pre-sales completes for every opportunity >$300K before contract signature — scoring staffing readiness, technical complexity, and delivery risk — so we only commit to what we can deliver excellently.",
                    ...
                    (K, "high", 5, "Sprint 3", ["readiness","americas"],
                     "As Katrina Rhodes, I want the Americas delivery lead to be involved in all opportunities >$500K during the Propose stage so that delivery perspective shapes the SOW before it's too late to change the scope.",
                    ...
                    (E, "high", 3, "Sprint 4", ["readiness","executive"],
                     "As Elena Fontaine, I want a 'Deliverability Score' visible on every contract above $1M at the approval stage so executives can assess execution risk alongside commercial risk before committing.",
            ...
            },
            {
                ...
                "stories": [
                    (E, "high", 5, "Sprint 4", ["readiness","csat"],
                     "As Elena Fontaine, I want a CSAT measurement program (structured surveys at 30 days and 90 days post go-live) with a target score of ≥4.2/5 across all completed projects so client satisfaction is measured consistently and acts as a leading indicator of renewal.",
                    ...
                    (M, "high", 5, "Sprint 5", ["readiness","knowledge"],
                     "As Marc van Vliet, I want a mandatory post-project retrospective (covering what worked, what didn't, and what we'd do differently) completed within 30 days of project closure for all engagements >$500K so learnings are captured systematically.",
                    ...
                    (K, "medium", 3, "Sprint 5", ["readiness","americas"],
                     "As Katrina Rhodes, I want a searchable Americas lessons-learned library so PMs can find relevant insights from similar historical engagements before starting a new project in the same industry or service area.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (M, "critical", 8, "Sprint 1", ["assets","presales","sow"],
                     "As Marc van Vliet, I want SOW templates for each of the 5 practice areas (Cloud, AI/Agentic, Dynamics, Security, Data & Analytics) pre-populated with standard scope, exclusions, assumptions, and RAID starters so pre-sales can produce a high-quality first draft in under 2 hours.",
                    ...
                    (K, "high", 5, "Sprint 2", ["assets","americas"],
                     "As Katrina Rhodes, I want SOW templates localized for Americas commercial terms, client communication style, and common Americas contract nuances (T&M vs. fixed price, SOX language) so our templates reflect how we actually do business in the region.",
                    ...
                    (E, "medium", 3, "Sprint 5", ["assets","governance"],
                     "As Elena Fontaine, I want a bi-annual SOW template review cycle where templates are updated to reflect current service offerings, pricing, and lessons learned so our assets stay current and don't drift from what we actually deliver.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "critical", 13, "Sprint 2", ["assets","playbooks"],
                     "As Marc van Vliet, I want delivery playbooks for our 10 most common engagement types (Azure LZ, Cloud Migration, D365 F&O, D365 CRM, Sentinel SOC, Zero Trust, Microsoft Fabric, Copilot Deployment, AI Custom Agent, and Data Strategy) each containing phase plans, milestone templates, RAID starters, and key decision points.",
                    ...
                    (K, "high", 5, "Sprint 4", ["assets","americas"],
                     "As Katrina Rhodes, I want a 'Quick Start' delivery playbook for engagements under $300K in Americas so that smaller fixed-price projects are still delivered with structure even when there's no budget for a senior PM.",
                    ...
                    (E, "medium", 3, "Sprint 6", ["assets","metrics"],
                     "As Elena Fontaine, I want IP reuse metrics (% of projects using a playbook or template, CSAT correlation with reuse) tracked and reported quarterly so we measure the ROI of our asset investment.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "high", 5, "Sprint 4", ["assets","communication"],
                     "As Marc van Vliet, I want a library of client communication templates (weekly status report, escalation notice, change request, milestone completion, project closure) so all PMs send professional, consistent communications that reflect our brand.",
                     ["8 communication templates published", "Templates reviewed by Elena Fontaine for tone and content", "Usage tracked to measure adoption"]),
                    (K, "medium", 3, "Sprint 5", ["assets","americas"],
                     "As Katrina Rhodes, I want an executive escalation email template for Americas PMs (when escalating to Katrina Rhodes or Elena Fontaine) with a structured format (situation, impact, decision needed, recommendation) so escalations are clear and action-oriented.",
                    ...
                    (M, "medium", 8, "Sprint 5", ["assets","architecture"],
                     "As Marc van Vliet, I want a library of validated solution architecture patterns (one per major service offering) that architects and PMs can reference and adapt so we reduce architecture design time and avoid reinventing solutions we've already built.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (E, "critical", 13, "Sprint 3", ["ai","delivery","executive"],
                     "As Elena Fontaine, I want an AI Delivery Co-Pilot that automatically analyzes all active project data weekly and generates a prioritized list of delivery risks — with specific recommended actions — so I can focus executive attention on the right projects at the right time.",
                    ...
                    (M, "critical", 8, "Sprint 3", ["ai","delivery"],
                     "As Marc van Vliet, I want an AI health analysis agent that a PM can ask 'What are the top risks on my project and what should I do about them?' and receive a structured, data-grounded response so PMs get expert-level coaching on demand.",
                    ...
                    (K, "high", 5, "Sprint 4", ["ai","americas"],
                     "As Katrina Rhodes, I want an AI-generated Americas weekly delivery digest (sent every Monday) summarizing portfolio health, highlighting emerging risks, and suggesting talking points for my regional review so I arrive at every meeting informed.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "critical", 8, "Sprint 4", ["ai","risk"],
                     "As Marc van Vliet, I want an AI agent that reads new RAID items entered by PMs and automatically suggests impact/probability scores, similar historical risks, and mitigation strategies so RAID quality is higher and PMs spend less time on taxonomy.",
                    ...
                    (K, "high", 5, "Sprint 4", ["ai","presales"],
                     "As Katrina Rhodes, I want an AI SOW generation agent that drafts a first-pass SOW narrative from a 10-bullet opportunity brief so Americas pre-sales can produce a complete draft SOW in under 30 minutes.",
                    ...
                    (E, "high", 8, "Sprint 5", ["ai","insights"],
                     "As Elena Fontaine, I want an AI portfolio analytics agent that detects anomalies in financial data (unexpected budget burns, margin drops, billing gaps) and routes alerts to the right person automatically so nothing slips through the cracks.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "high", 8, "Sprint 5", ["ai","productivity"],
                     "As Marc van Vliet, I want an AI agent that transcribes project meeting recordings and automatically extracts action items, decisions, risks, and RAID items — structured and ready to import into the project tool — so PMs save at least 2 hours per week on note-taking and follow-up.",
                    ...
                    (K, "high", 5, "Sprint 5", ["ai","reporting"],
                     "As Katrina Rhodes, I want an AI-assisted weekly status update generator that drafts the client status update from live project data (milestones, RAID, budget, schedule) so Americas PMs spend 15 minutes on reporting instead of 2 hours.",
                    ...
                    (E, "high", 5, "Sprint 6", ["ai","planning"],
                     "As Elena Fontaine, I want an AI milestone planning agent that generates a proposed project milestone plan for new projects based on the selected delivery playbook and historical comparable projects so every project starts with a stronger baseline plan.",
        ...
        "features": [
            {
                ...
                "stories": [
                    (M, "high", 8, "Sprint 2", ["methodology","mdf"],
                     "As Marc van Vliet, I want all active PMs trained and certified on the Microsoft Delivery Framework (MDF) — including phase gates, deliverables, and quality checkpoints — so our delivery approach is consistent and defensible in any client conversation.",
                    ...
                    (E, "high", 5, "Sprint 3", ["methodology","metrics"],
                     "As Elena Fontaine, I want an MDF compliance score per project (tracking adherence to MDF phase gates and required deliverables) visible in the portfolio dashboard so delivery methodology rigor is measurable and reportable.",
                    ...
                    (K, "medium", 3, "Sprint 3", ["methodology","americas"],
                     "As Katrina Rhodes, I want a 1-page MDF 'phase cheat sheet' for each of the 5 delivery phases so Americas PMs have a quick, portable reference they can use in the field without opening a 50-page document.",
            ...
            },
            {
                ...
                "stories": [
                    (M, "high", 8, "Sprint 3", ["methodology","agile"],
                     "As Marc van Vliet, I want an 'Agile for Professional Services' playbook that adapts Scrum/Kanban for consulting engagements — addressing milestone billing, client sprint reviews, and fixed-scope-agile-execution tensions — so PMs can offer agile delivery without commercial risk.",
                    ...
                    (K, "high", 5, "Sprint 4", ["methodology","americas"],
                     "As Katrina Rhodes, I want Agile delivery training for Americas PMs (covering the PS-adapted model) so we can offer agile-native delivery to the growing number of Americas clients who expect it.",
                    ...
                    (E, "medium", 3, "Sprint 5", ["methodology","executive"],
                     "As Elena Fontaine, I want a hybrid agile-waterfall delivery model documented and approved so PMs have a formal option for regulated-industry engagements that need milestone tracking alongside iterative development.",
                     ["Hybrid model covers finance, healthcare, and utilities contexts", "Approved by Elena Fontaine and legal", "First project using hybrid model tracked as pilot by Q4 2026"]),
                ]
            },
            {
                ...
                "stories": [
                    (M, "critical", 13, "Sprint 3", ["methodology","ai"],
                     "As Marc van Vliet, I want an AI Project Delivery Methodology covering AI readiness assessment, data governance, model validation, responsible AI review, and change management so our growing AI portfolio is delivered with the same discipline as our cloud and Dynamics practices.",
                    ...
                    (K, "high", 5, "Sprint 4", ["methodology","americas"],
                     "As Katrina Rhodes, I want AI delivery methodology training for all Americas PMs so we can confidently staff and deliver the growing AI book of business without senior delivery leader involvement in every project.",
                    ...
                    (M, "high", 5, "Sprint 4", ["methodology","caf"],
                     "As Marc van Vliet, I want Cloud Adoption Framework (CAF) stages mapped to our delivery playbooks and SOW templates for all cloud engagements so every cloud project aligns to the Microsoft reference model and we can demonstrate methodology rigor to clients.",
